...
import com.cdt.curriculumdesign.base.model.LoginuserExample.Criteria;
import com.cdt.curriculumdesign.base.model.LoginuserExample.Criterion;
...
public class LoginuserSqlProvider {
    public String countByExample(LoginuserExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("loginuser");
