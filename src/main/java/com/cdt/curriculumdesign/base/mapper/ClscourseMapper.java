...
public interface ClscourseMapper {
    ...
    @Select({
        "select",
        "ClsCourseId, CourseId, ClassId, TeacherId, CourseName, CourseStartTime, CourseEndTime, ",
        "CourseStartWeek, CourseEndWeek, CourseWeek, CourseDayNum, CourseStatus, CourseType",
        "from clscourse",
        "where ClsCourseId = #{clscourseid,jdbcType=BIGINT}"
    })
    @Results({
