...
public interface CourseMapper {
    ...
    @Select({
        ...
        "CourseDayNum, CourseStatus, CourseType, CourseDesc",
        "from course",
        "where CourseId = #{courseid,jdbcType=BIGINT}"
    })
    @Results({
